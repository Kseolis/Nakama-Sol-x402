...
Licensor:             Nakama Labs

Licensed Work:        nakama-x402-facilitator (off-chain x402 payment
                      facilitator service for the Nakama Protocol).
                      The Licensed Work is (c) 2026 Nakama Labs.

Additional Use Grant: You may make use of the Licensed Work, provided that
                      you do not use the Licensed Work for a Commercial
                      Service. A "Commercial Service" is a service offered
                      to third parties (whether or not for a fee) that
                      provides Solana subscription billing infrastructure,
                      x402 payment facilitation, recurring USDC payment
                      orchestration, or unified escrow services that
                      compete with the Licensed Work.

                      Internal business use, evaluation, research,
                      education, and personal projects are permitted.
